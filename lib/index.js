...
SnapchatPixel.prototype.productAdded = function(track) {
    window.snaptr('track', 'ADD_CART', {'number_items': track.quantity() || 1});
};
...
SnapchatPixel.prototype.checkoutStarted = function(track) {
    var currency = track.currency() || '';
    var total = track.revenue() || track.value() || 0;
 ...
 * @param {Track} track
 */
SnapchatPixel.prototype.paymentInfoAdded = function(track) {
